...
const (
	Message_UNPROCESSED Message_Status = 0
	Message_PROCESSING  Message_Status = 1
	Message_PROCESSED   Message_Status = 2
)
...
type Consumer struct {
	...
	Queue []*Message `protobuf:"bytes,1,rep,name=Queue,proto3" json:"Queue,omitempty"`
}
...
func (x *Consumer) GetQueue() []*Message {
	if x != nil {
		return x.Queue
	}
	return nil
...
var file_client_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2a,
	0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x12, 0x1e, 0x0a, 0x05, 0x51, 0x75,
	0x65, 0x75, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x05, 0x51, 0x75, 0x65, 0x75, 0x65, 0x22, 0x22, 0x0a, 0x06, 0x53, 0x74,
	...
	0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x38, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x44, 0x10, 0x02, 0x32, 0x2f, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1c, 0x0a, 0x07, 0x45, 0x6e, 0x51, 0x75, 0x65, 0x75,
	0x65, 0x12, 0x08, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x07, 0x2e, 0x53, 0x74,
...
var file_client_proto_goTypes = []interface{}{
	(Message_Status)(0), // 0: Message.Status
	(*Consumer)(nil),    // 1: Consumer
	(*Status)(nil),      // 2: Status
	(*Message)(nil),     // 3: Message
}
var file_client_proto_depIdxs = []int32{
	3, // 0: Consumer.Queue:type_name -> Message
	3, // 1: ConsumerService.EnQueue:input_type -> Message
	2, // 2: ConsumerService.EnQueue:output_type -> Status
